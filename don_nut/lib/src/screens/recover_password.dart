       ...
       children: <Widget>[
        ...
        Image.network("https://media.discordapp.net/attachments/775922349362642955/906604815361134592/logo.png?width=200&height=150"),
          ...
          const Text(
            ...
            style: TextStyle(color: Color(0xff707070),fontWeight: FontWeight.w900,fontSize: 20),
          ),
          const SizedBox(height: 25),
          const Text(
            "Ingresa tu correo y te enviaremos los \n"
            "          pasos para recuperarla",
            style: TextStyle(color: Color(0xff707070),fontWeight: FontWeight.w600,fontSize: 17),
          ),
          const SizedBox(height: 25),
          SizedBox(
            width: 285,
